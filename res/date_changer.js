...
function date_changer(){
	...
	output += '</select>';
	output += '<img title="Change" class="changer_ok" src="typo3conf/ext/newssdf/res/accept.png" />';
	output += '<img title="Cancel" class="changer_no" src="typo3conf/ext/newssdf/res/cancel.png" />';
	return output;
}
